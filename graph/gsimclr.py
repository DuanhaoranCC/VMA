...
#     "w": hp.choice('w', [0.0, 1e-5, 5e-5, 1e-4, 5e-4, 1e-3, 5e-3, 1e-2, 5e-2]),
...
#TT({'lr': 0.0005, 'p1': 0.8, 'p2': 0.70, 'p3': 0.6, 'tau': 0.5, 'w':0.0})
#TT({'lr': 0.005, 'p1': 0.0, 'p2': 0.8, 'p3': 0.8, 'tau': 0.3, 'w': 0.0005})
#TT({'lr': 8e-05, 'p1': 0.8, 'p2': 0.6, 'p3': 0.5, 'tau': 0.6, 'w': 0.05})
#TT({'lr': 5e-05, 'p1': 0.7, 'p2': 0.3, 'p3': 0.2, 'tau': 1.0, 'w': 0.0})
#TT({'lr': 5e-05, 'p1': 0.8, 'p2': 0.7, 'p3': 0.4, 'tau': 0.60, 'w': 0.05})
#TT({'lr': 0.0008, 'p1': 0.7, 'p2': 0.6, 'p3': 0.5, 'tau': 0.1})
#TT({'lr': 0.0005, 'p1': 0.8, 'p2': 0.2, 'p3': 0.4, 'tau': 0.4, 'w': 0.01})